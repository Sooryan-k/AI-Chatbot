...
//
// the redirect uses status 303 (see other) so the browser follows it with a
// GET. the default 307 would preserve the POST method and re-post to the login
// page, which only handles GET and would answer 405.
//
